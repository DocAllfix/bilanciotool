...
**Prossima: Fase 8** — generatore documenti (snapshot immutabili, template GHG §9.3.1 e Bilancio, PDF serverless). ⚠️ QUI serve collegare Vercel (l'utente va avvisato: deciso in precedenza).
