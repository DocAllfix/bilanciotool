...
**Prossima: Fase 7** — modulo Bilancio frontend (percorso 7 passi, editor Tiptap, matrice materialità, media manager). Vercel si collega in Fase 8 (deciso con l'utente).
