...
**Prossima: Fase 5** — modulo GHG frontend: percorso 8 passi, portfolio reale, server actions "use server" che cablano guard→funzioni F4. Vercel si collega in Fase 8 (deciso con l'utente).
