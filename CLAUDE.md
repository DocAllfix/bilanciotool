...
**Prossima: Fase 4** — modulo GHG backend (`src/features/ghg/`): server actions dietro guard+entitlement, import JSON, results via `src/lib/calc`. Zero UI. Vercel si collega in Fase 8 (deciso con l'utente).
