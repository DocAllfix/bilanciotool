...
export const ETICHETTE_AUDIT: Record<string, string> = {
  ...
  "filiera.programma.create": "Programma di due diligence avviato",
  "filiera.profilo.set": "Programma di filiera aggiornato",
  "filiera.partner.create": "Partner mappato",
  "filiera.partner.set": "Scheda del partner aggiornata",
  ...
  "corpus.insieme.pdf": "Fascicolo del corpus scaricato in PDF",
  ...
  "documento.analisi_ambientale.publish": "Analisi ambientale pubblicata",
  ...
  "documento.diagnosi_esg.publish": "Rapporto di diagnosi ESG pubblicato",
  "documento.dossier_finale.publish": "Dossier di chiusura pubblicato",
  "documento.offerta_esg.pdf": "Offerta professionale scaricata in PDF",
  "documento.verbale_avvio.pdf": "Verbale di avvio scaricato in PDF",
  "documento.diagnosi_esg.pdf": "Rapporto di diagnosi ESG scaricato in PDF",
  "documento.dossier_finale.pdf": "Dossier di chiusura scaricato in PDF",
  ...
  "documento.analisi_ambientale.pdf": "Analisi ambientale scaricata in PDF",
