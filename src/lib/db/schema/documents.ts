...
export const documentSnapshot = pgTable(
  "document_snapshot",
  {
    ...
    tipo: text("tipo", { enum: ["ghg", "bilancio", "energetico", "attestato", "soa", "relazione_pc", "matrice_pc", "matrice_231", "relazione_odv", "relazione_wb", "riesame_qas", "manuale_sa8000"] }).notNull(),
